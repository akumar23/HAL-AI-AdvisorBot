...
basicAdvice = [
    ...
    "To graduate from SJSU, you need a minimum cumulative GPA of 2.0. Additionally, you need a 2.0 GPA in your major courses. Some programs may have higher requirements, so check with your advisor.",
    "what is the minimum gpa to graduate",
    "To graduate from SJSU, you need a minimum cumulative GPA of 2.0. Additionally, you need a 2.0 GPA in your major courses. Some programs may have higher requirements, so check with your advisor.",
    "gpa requirements for graduation",
    "To graduate from SJSU, you need a minimum cumulative GPA of 2.0. Additionally, you need a 2.0 GPA in your major courses. Some programs may have higher requirements, so check with your advisor.",
    "how many units do i need to graduate",
    "For CMPE/SE majors, you typically need 120-130 units to graduate. This includes major requirements, GE requirements, and electives. Check your major's roadmap for specific requirements.",
    "what are the graduation requirements",
    "To graduate you need: (1) minimum 2.0 cumulative GPA, (2) 2.0 GPA in major, (3) complete all major requirements, (4) complete all GE requirements, (5) complete 120-130 total units depending on major, (6) apply for graduation 2 semesters before your expected graduation date.",
    "how do i check my degree progress",
    "Go to your mySJSU page and click on 'myProgress' to see your degree audit. This shows which requirements you've completed and what you still need.",
    "what is academic probation",
    "You are placed on academic probation if your cumulative GPA falls below 2.0. You must raise your GPA above 2.0 to get off probation. If you remain on probation, you may be disqualified.",
    "what happens if my gpa is below 2.0",
    "If your cumulative GPA falls below 2.0, you will be placed on academic probation. You'll need to meet with an advisor and create a plan to improve your grades. If your GPA stays below 2.0, you may be disqualified from the university.",
    "can i take a class pass/no pass",
    "You can take some elective courses as pass/no pass (Credit/No Credit). Major requirements and most GE courses must be taken for a letter grade. Check with your advisor before selecting this option.",
    "what is the w grade",
    "A 'W' (Withdrawal) appears on your transcript when you officially withdraw from a class after the drop deadline. It doesn't affect your GPA but does appear on your record. You can have limited W grades before it becomes a concern.",
    "what is an incomplete grade",
    "An Incomplete (I) grade is given when you cannot complete coursework due to circumstances beyond your control. You must complete the work by the deadline set by the instructor, typically within one year, or it converts to an F.",
    "how do i declare my major",
    "To declare or change your major, visit the CMPE department office or contact an advisor. You may need to meet certain prerequisites and GPA requirements to change into impacted majors like CMPE or SE.",
    "what is an impacted major",
    "CMPE and SE are impacted majors, meaning they have more applicants than spaces available. You need to meet specific GPA and prerequisite requirements to be admitted or change into these majors.",
    "can i double major",
    "Yes, you can pursue a double major at SJSU. You'll need to complete the requirements for both majors. Meet with advisors from both departments to plan your coursework.",
    "what is a minor",
    "A minor is a secondary area of study requiring 15-24 units. CMPE and CS offer minors. Adding a minor can complement your major and enhance your career prospects.",
    "how do i add a minor",
    "To add a minor, complete the minor declaration form and submit it to the department offering the minor. Make sure you can complete the requirements before graduation.",
    "what are office hours",
    "Office hours are times when professors are available to meet with students. Check your syllabus or the department website for your professor's office hours. You can also email professors to schedule appointments.",
    "where is the engineering building",
    "The main engineering building is the Charles W. Davidson College of Engineering building. CMPE and SE classes are typically held in the Engineering building on San Fernando Street.",
    "what tutoring is available",
    "SJSU offers tutoring through the Peer Connections center in the Student Services Center. The College of Engineering also has tutoring resources. Check the CMPE website for department-specific tutoring.",
    "how do i get an internship",
    "Start by visiting the Career Center and attending career fairs. Use Handshake (SJSU's job platform) to find internship opportunities. Network with professors and attend industry events. Many companies recruit at SJSU engineering career fairs.",
    "when should i apply for internships",
    "Start applying for summer internships in the fall semester (August-November). Many tech companies have early deadlines. Update your resume and practice coding interviews. The Career Center offers resources to help prepare.",
    "do internships count for credit",
    "Yes, you can receive academic credit for internships through CMPE 190 or similar courses. You need department approval and must complete required hours and deliverables. Talk to your advisor about the process."
]
